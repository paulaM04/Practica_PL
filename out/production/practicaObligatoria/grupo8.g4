...
ctelist returns [Variable var] : ID '=' simpvalue {$var=new Variable($ID.text, $simpvalue.valor);}';'  ctelistPrima[varP];
ctelistPrima [Variable varP]: ID '=' simpvalue ';' ctelistPrima [varP]{$varP=new Variable($ID.text, $simpvalue.valor);} | {};
