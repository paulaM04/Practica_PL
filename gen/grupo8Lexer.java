...
public class grupo8Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "CONSTINT", "CONSTREAL", 
			"ID", "CONSTLIT", "COMENTARIOS_UNA_LINEA", "COMENTARIOS_MAS_LINEAS", 
			"WS"
		};
	}
	...
	public grupo8Lexer(CharStream input) {
		super(input);
